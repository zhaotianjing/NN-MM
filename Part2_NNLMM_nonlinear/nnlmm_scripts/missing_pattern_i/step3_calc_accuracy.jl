...
main_path="/group/qtlchenggrp/tianjing/omics_sample_all/nonlinear/varmi_2/missing_pattern_legarra/"
pctAll=["0.5","0.7","0.9"]
nRep=10
chain_length=5000
#read bv
bv=vec(readdlm("/group/qtlchenggrp/tianjing/omics_data/nonlinear/varmi_2/data1/tbv.txt"));
